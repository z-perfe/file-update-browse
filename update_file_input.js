...
// 上传
$(document).on('click', '#upload_submit', () => {
...
// 两个浏览选项的更改
$(document).on('change', '#select_show_type', function () {
    image_list(1);
});
$(document).on('change', '#select_show_path', function () {
    image_list(1);
});
// 图片列表点击
...
$(document).on('click', '#browse_submit', function () {
...
// 添加外部链接
$(document).on('click', '#add_ext_submit', function () {
